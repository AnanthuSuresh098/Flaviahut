...
//             <aside className='bg-white min-h-full w-full md:w-60 customShadow border flex flex-col items-center p-4'>
            

//                 <nav className='w-full grid gap-2 p-4 text-center'>
...
//                 <button
//                     className='border-2 border-red-600 text-red-600 hover:bg-red-600 hover:text-white transition-all py-1 px-4 rounded-full mt-auto mb-4 md:mb-0'
