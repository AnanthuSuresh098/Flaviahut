...
//   return (
//     <div>
//       <h2 className="text-2xl font-bold mb-4">{currentAddress ? "Edit Address" : "Add Address"}</h2>
...
//         <div className="col-span-2">
//           <label className="block mb-2 text-sm font-medium">Additional Info</label>
//           <input
//             type="text"
//             name="notes"
//             value={data.notes}
...
//         <button type="submit" className="col-span-2 bg-[#AA0000] text-white p-4 rounded-lg mt-4">
...
const AddressForm = ({ userId, currentAddress, onSave }) => {
  ...
  const validateFields = () => {
    ...
    if (!data.email || !data.phone || !data.address || !data.city || !data.pincode) {
