    ...
    <header className="shadow-md bg-white w-full z-40   sticky top-0">
      <div className="w-full">
        ...
        <div className="bg-red-700 text-white text-xs md:text-sm py-2 px-4 flex justify-between items-center">
          <div>
            <span className="mr-1">📍 Store Location:</span>
            <span>#985/986 Housing Board Colony Sector 10 Ambala City</span>
          </div>
        ...
        <div className="bg-white shadow-md px-4  ">
          <div className="flex  justify-between items-center " style={{whiteSpace: "nowrap"}}>
            ...
            <div className="flex-grow ">
              <img src={logos} alt="logo" className="h-20 w-25" />{" "}
              ...
              <div className="p-4 ">
                ...
                <div className="mt-6 ">
                  <ul className="space-y-12" >
                    <li className="flex items-center space-x-2" onClick={toggleDrawer}>
                      <span>
                    ...
                    {isProductDropdownOpen && (
                      <div className="ml-8 space-y-2">
                        {loading
                          ...
                          : categoryProduct?.map((product, index) => (
                              <ul className="py-2" key={index} onClick={toggleDrawer}>
