...
const ProductCard = ({ product, handleAddToCart, wishlistHandler }) => {
  ...
  return (
    ...
    <div className="w-full min-w-[230px] md:min-w-[220px] max-w-[230px] md:max-w-[220px] h-[310px] bg-white rounded-md shadow-lg overflow-hidden relative md:hover:scale-105 transition-transform rounded md:hover:border md:hover:border-[#AA0000] border border-[#EDEDED]">
      <Link to={"/product/" + product?._id}>
        ...
        {/* Product Image */}
        <div className="bg-slate-200 h-[180px] min-w-[180px]">
          <img
